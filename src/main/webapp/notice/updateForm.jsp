...
<input type="hidden" value="${dto.mem_id }" name="Mem_id">
 <table class="question" id="notice">
  ...
  <tr>
   ...
   <td style="background: white;"> ${dto.no_num }</td>
   </tr>
   <tr>
   <td>글쓴이</td>
   ...
   <tr>
      <td style="background: white;">제목</td>
        <td colspan="2" style="background: white;">
               <input type="text" name="No_title" style="width: 500px"; value="${dto.no_title }">
       </td>
    </tr>
     ...
     <tr>
      <td>내용</td>
      <td colspan="4">
        <textarea rows="20" cols="50" name="No_content">${dto.no_content }</textarea>
