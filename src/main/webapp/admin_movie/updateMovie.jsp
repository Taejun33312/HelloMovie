    ...
    <form action="./AdminMovieUpdate.mm" method="post"  enctype="multipart/form-data">
     ...
     <select name="M_type">
        ...
        <tr>
            ...
            <td><input type="text"  class="wid20" name="M_director" value="${dto.m_director }"/>
            </td>
        </tr>
        <tr>
            <th class="th" scope="row">관람등급</th>
            <td><input type="text"  class="wid20" name="M_age" value="${dto.m_age }" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="date"  class="wid20" name="M_playDate" value="${dto.m_playDate }"/>
            </td>
         	</tr>
        <tr>
            <th class="th" scope="row">설명</th>
            <td><input type="text"  class="wid20" name="M_explain" value="${dto.m_explain }"/>
            </td>
        </tr>
        <tr>
            <th class="th" scope="row">평점</th>
            <td><input type="text"  class="wid20" name="M_grade" value="${dto.m_grade }"/>
            </td>
        </tr>
        <tr>
            <th class="th" scope="row">예매율</th>
            <td><input type="text" class="wid20" name="M_reservationRate" value="${dto.m_reservationRate }" />
            </td>
        </tr>
