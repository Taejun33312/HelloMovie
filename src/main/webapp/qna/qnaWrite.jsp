...
<jsp:include page="/inc/top.jsp"/>
  ...
  <table class="question">
    <caption class="qtit"><h2>1:1 문의사항</h2></caption>
    
        <!-- <tr>
            <th class="th" scope="row">극장선택</th>
            <td><select name="admin" class="wid10" title="카테고리 선택">
        ...
        <tr>
            ...
            <td>
             <textarea title="문의사항" class="wid30"  placeholder="1000자 이내(2000byte)로 입력해 주세요" name="Mem_content"></textarea>
            </td>
        </tr>
  </table>
      ...
      <div class="btngreen">
         ...
         <p> <input type="button" class="Btn" value="돌아가기" onclick="location.href='./QnaListAction.qa';"></p>
<!-- //Form -->
