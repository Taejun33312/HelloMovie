...
<form action="./QnaUpdateActionPro.qa?Q_num=${dto.q_num }&pageNum=${pageNum}" method="post">
 ...
 <table class="question" id="notice">
   <caption class="qtit"><h2>1:1문의사항</h2></caption> 	 
    ...
    <th>글번호</th>
    <td>
    <input type="text" name="Q_num" value="${dto.q_num }" readonly>
    </td>
   </tr>
   <tr>
   <th>글쓴이</th>
   <td>
   <input type ="text" name="Mem_id" value="${dto.mem_id }" readonly>
   </td>
   ...
   <tr>
      <th>제목</th>
      <td colspan="3">
      <input type ="text" name="Mem_subject" value="${dto.mem_subject }">
      </td>
    </tr>
     ...
     <tr>
      <th>내용</th>
      <td colspan="3">
        <textarea rows="10" cols="30" name="Mem_content">${dto.mem_content }</textarea>
      </td>
	  </tr>
