...
<div class="site-wrapper">
	...
	<form action="./bookAction.bk" method="post">
		...
		<input type="hidden" value="${yDiscount }" name="yDiscount">
		...
		<input type="hidden" value="${gDiscount }" name="gDiscount">
		<table>
			<tr>
				<td>할인 종류</td>
