...
public class LoginAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		System.out.println("멤버번호" + dto.getMem_num());
		int ticketCount = dao.getTicketCount(dto.getMem_num());
		System.out.println(ticketCount + "티켓카운트!");
		dao.updateGrade(ticketCount, dto.getMem_num());
